...
export default function Home() {
  ...
  return (
    <main className="bg-base h-screen w-screen flex flex-col items-center justify-center">
      <Toaster />
      <div className={`${isResetingPassword && "flex flex-col justify-center"} bg-white w-[450px] min-h-[545px] py-8 px-12 border-lavender border-solid border-2 rounded-xl shadow-xl`}>
        { !loading ?
          (
            <>
              { !isResetingPassword ? 
                (
                  ...
                  <>
                    <h1 className={`font-bold text-textBase text-2xl text-center ${!isResetingPassword && "mt-20"}`}>Type your email to reset your password</h1>
                    <form onSubmit={(e: React.FormEvent) => handleForm(e)}  className="flex flex-col gap-6 mt-10">
                      <Input 
                        type="email"
                        placeholder="Email"
...
const Spinner = () => {
  return (
    ...
    <div className="flex justify-center items-center" role="status">
      <svg aria-hidden="true" className="w-11 h-11 text-gray-200 animate-spin dark:text-gray-600 fill-lavender" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
