...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <main className="bg-base dark:bg-baseDark h-screen w-screen flex flex-col items-center justify-center">


        <Toaster />
        <div className={`${isResetingPassword && "flex flex-col justify-center"} relative bg-white dark:bg-foregroundDark w-[450px] min-h-[548px] py-8 px-12 border-lavender border-solid border-2 rounded-xl shadow-xl`}>
            ...
            (
              <>
                { !isResetingPassword ? 
                  (
                    <>  
                      <h1 className="font-bold text-textBase dark:text-textBaseDark text-2xl text-center mt-20">Access your account</h1>
                      <form onSubmit={(e: React.FormEvent) => handleForm(e)}  className="flex flex-col gap-6 mt-10">
                        ...
                        <div className="flex flex-row justify-between items-center gap-2 mb-12">
                          <div className="flex flex-row items-center gap-1">
                            ...
                            />
                            <Label htmlFor="remember-password" className="text-xs dark:text-textBaseDark">Remember</Label>
                          </div>
                        ...
                        <div className="flex flex-col">
                          ...
                          <p className="text-xs text-textBase dark:text-textBaseDark text-center mt-4">
                    ...
                    <>
                      <h1 className={`font-bold text-textBase dark:text-textBaseDark text-2xl text-center ${!isResetingPassword && "mt-20"}`}>Type your email to reset your password</h1>
                      <form onSubmit={(e: React.FormEvent) => handleForm(e)}  className="flex flex-col gap-6 mt-10">
                        <Input 
                          type="email"
                          placeholder="Email"
